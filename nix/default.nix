...
let
  ...
  nixpkgs = _nixpkgs.fetchFromGitHub {
    owner = "NixOS";
    repo = "nixpkgs";
    rev = "d2b08c432cc9ec35691ab27085dfc7c6f404448b";
    sha256 = "1s1kbyszlw8270f9brvvxfchx03ylawssmg0sqbx2msly4fzr01v";
  };
  ...
  fetch-github-json = owner: repo: path:
    ...
    compiler = if frontend then "ghcjs" else "ghc8_2_1"; filterPredicate = p: type:
